...
userModel.seed = function(){
	var defaultUser = new User({username:'ali@gmail.com', password:'5f4dcc3b5aa765d61d8327deb882cf99', activeSession:''});
	defaultUser.save(function(err, user) {
	  if(err) console.dir('error occured in populating database');
	});

	defaultUser = new User({username:'harry@gmail.com', password:'5f4dcc3b5aa765d61d8327deb882cf99', activeSession:''});
	defaultUser.save(function(err, user) {
	  if(err) console.dir('error occured in populating database');
	});

	defaultUser = new User({username:'tom@gmail.com', password:'5f4dcc3b5aa765d61d8327deb882cf99', activeSession:''});
	defaultUser.save(function(err, user) {
	  if(err) console.dir('error occured in populating database');
	});
